...
//MARK: -- 懒加载
    ...
    lazy var pageControl : UIPageControl = {[weak self] in
        ...
        let pageControl:UIPageControl = UIPageControl(frame: CGRect(x: self!.bounds.width / 2, y: self!.bounds.height - 20, width: self!.bounds.width / 2, height: 20))
...
//        pageControl.bounds = CGRect(x: self!.bounds.width / 2, y: pageControl.bounds.height - 20, width: pageControl.bounds.width / 2, height: 20)
        pageControl.center = CGPoint.init(x: self!.bounds.width / 2, y: pageControl.center.y)
        return pageControl
    }()
